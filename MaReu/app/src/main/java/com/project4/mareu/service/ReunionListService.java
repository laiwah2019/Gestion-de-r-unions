...
public class ReunionListService {
    ...
    private static List<Reunion> mReunionListGenerate = Arrays.asList(
            new Reunion("Reunion A", 0, "Peach", "04/04/2020", "14 h 00", "maxime@lamzone.com, alex@lamzone"),
            new Reunion("Reunion B", 1, "Mario", "04/04/2020", "16 h 00", "paul@lamzone.com, viviane@lamzone.com"),
            new Reunion("Reunion C", 3, "Luigi", "07/04/2020", "19 h 00", "amandine@lamzone.com, luc@lamzone.com")
    );
