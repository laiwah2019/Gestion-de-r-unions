...
public class ReunionListService {
    ...
    private static List<Reunion> mReunionListGenerate = Arrays.asList(
            new Reunion("Reunion A", 0, "Peach", "04/04/2019", "14h00", "maxime@lamzone.com,alex@lamzone"),
            new Reunion("Reunion B", 1, "Mario", "04/04/2019", "16h00", "paul@lamzone.com,viviane@lamzone.com"),
            new Reunion("Reunion C", 3, "Luigi", "07/04/2019", "19h00", "amandine@lamzone.com,luc@lamzone.com")
    );
